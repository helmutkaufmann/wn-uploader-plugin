...
class UploadForm extends Model
{
    ...
    protected $casts = [
        ...
        'max_total_file_size'     => 'integer',   // MB
    ...
    /** ADD: restricted + limits / editor / exif to fillable */
    public $fillable = [
        'form_id','title','description','upload_dir','allowed_types',
        'start_date','end_date','timezone',
        'client_resize_enabled','client_resize_max_width','client_resize_max_height',
        'client_resize_quality','auto_upload_enabled',
        'preserve_exif','max_file_size','max_total_file_size','use_image_editor',
        'restricted',
    ];
    ...
    public $rules = [
        ...
        /** ADD: limits validation (0 = unlimited) */
        'max_file_size'           => 'nullable|integer|min:0|max:102400',        // up to 100 GB if ever needed
        'max_total_file_size'     => 'nullable|integer|min:0|max:204800',       // up to 200 GB
    ];
